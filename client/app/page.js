...
export default function Home() {
  return (
    <main className="min-h-screen bg-black text-white selection:bg-white selection:text-black">
      ...
      {/* Live Stats Ticker */}
      <section className="py-8 border-y border-white/10 bg-gradient-to-r from-zinc-950 via-zinc-900 to-zinc-950">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-center items-center gap-12 text-center">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">Platforms Integrated</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 md:px-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="p-8 border border-white/20 rounded-2xl hover:border-blue-500/50 transition-all group bg-gradient-to-br from-zinc-900 to-zinc-950">
          ...
          <div className="p-8 border border-white/20 rounded-2xl hover:border-purple-500/50 transition-all group bg-gradient-to-br from-zinc-900 to-zinc-950">
          ...
          <div className="p-8 border border-white/20 rounded-2xl hover:border-green-500/50 transition-all group bg-gradient-to-br from-zinc-900 to-zinc-950">
